	...
	public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
	        ...
	        case 1:
	        	...
	        	editText = (EditText) dialog_rename.findViewById(R.id.txtRenameTitle);
	    		errorMessage = (TextView) dialog_rename.findViewById(R.id.dialogErrorMessage);
	    		...
	    		editText.setText(originalFeed.title);
	    		...
	    		dialogButtonRenameSubmit.setOnClickListener(new OnClickListener() {
	    			@Override
	    			public void onClick(View v) {
	    				EditText editText = (EditText) dialog_rename.findViewById(R.id.txtRenameTitle);
	    				...
	    				if (!(editText.getText().toString()).equals(originalFeed.title) || 
    						(notifyBox.isChecked()) != (originalFeed.notify > 0) ||
    						(widgetableBox.isChecked()) != (originalFeed.widgetable > 0)) {
	    					
	    					String title = editText.getText().toString();
    						if (title.length() < 1) {
    							errorMessage.setText("Die Eingabefelder dürfen nicht leer sein.");
    						} else {
	    				...
	    				if (!(editText.getText().toString()).equals(originalFeed.title) ||
	    					...
	    					originalFeed.title = editText.getText().toString();
